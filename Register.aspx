...
<body data-spy="scroll" data-target="#myScrollspy" data-offset="20">
    ...
    <!----Login Code Style--->
      <div class="container">    
        <div id="loginbox" style="margin-top:125px; display:none " class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
        ...
        <div id="signupbox" style="display:block; margin-top:125px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                    <div class="panel panel-info">
                        <div class="panel-heading" style="background-color:rgb(17, 16, 16)">
                            <div class="panel-title">Sign Up</div>
                            <div style="float:right; font-size: 85%; position: relative; top:-10px"><a id="signinlink" href="#" onclick="$('#signupbox').hide(); $('#loginbox').show()" style="color:whitesmoke">Sign In</a></div>
                        </div>  
